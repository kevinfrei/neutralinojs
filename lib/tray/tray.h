...
// Template your way around type safety XD
template <typename... ARGS> id ObjC_msgSend(id _id, SEL _sel, ARGS... args) {
  return ((id (*)(id, SEL, ARGS...))objc_msgSend)(_id, _sel, args...);
};
